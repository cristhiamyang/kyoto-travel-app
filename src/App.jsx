...
const initialItineraryData = [
  {
    ...
    activities: [
      ...
      { id: 4, type: '景點', time: '14:30-18:00', title: '心齋橋筋商店街 & 道頓堀', detail: '逛街購物,看「固力果跑跑人」看板。', cost: 0, guide: '' },
      { id: 5, type: '餐飲', time: '18:00-21:00', title: '晚餐 (道頓堀美食)', detail: '必吃美食: 章魚燒、大阪燒、金龍拉麵。', cost: 3500, guide: '' },
    ],
    weather: null,
  },
  {
    ...
    activities: [
      ...
      { id: 7, type: '餐飲', time: '13:00-14:30', title: '午餐: 天保山購物中心', detail: '在美食廣場或餐廳用餐', cost: 1500, guide: '' },
  ...
  },
  {
    ...
    activities: [
      ...
      { id: 17, type: '餐飲', time: '19:00-21:00', title: '晚餐', detail: '必吃美食: 神戶牛 (建議提前預約)。', cost: 10000, guide: '' },
    ],
    weather: null,
  },
  {
    ...
    activities: [
      ...
      { id: 20, type: '景點', time: '13:00-17:00', title: '東山區 (清水寺)', detail: '搭乘巴士前往清水寺,沿途經過二年坂、三年坂。', cost: 400, guide: '' },
      { id: 21, type: '景點', time: '17:00-19:00', title: '祇園 & 花見小路', detail: '漫步祇園古街,感受京都傳統藝妓文化。', cost: 0, guide: '' },
      { id: 22, type: '餐飲', time: '19:00-21:00', title: '晚餐', detail: '在祇園或河原町區域用餐。', cost: 3000, guide: '' },
    ],
    weather: null,
  },
  {
    ...
    activities: [
      ...
      { id: 24, type: '餐飲', time: '14:00-15:30', title: '午餐 (嵐山周邊)', detail: '在嵐山周邊用餐。', cost: 2000, guide: '' },
      { id: 25, type: '景點', time: '15:30-17:30', title: '金閣寺 (鹿苑寺)', detail: '搭乘巴士前往金閣寺,欣賞冬季景色。', cost: 500, guide: '' },
      { id: 26, type: '購物', time: '17:30-20:00', title: '河原町・錦市場', detail: '逛逛京都的廚房「錦市場」(部分店家可能已關門)或河原町百貨區。', cost: 0, guide: '' },
      { id: 27, type: '餐飲', time: '20:00-22:00', title: '晚餐', detail: '在河原町或返回京都車站用餐。', cost: 3000, guide: '' },
    ],
    weather: null,
  },
  {
    ...
    activities: [
      ...
      { id: 29, type: '景點', time: '10:00-12:30', title: '平等院 (Byodo-in Temple)', detail: '參觀世界遺產鳳凰堂,是10日圓硬幣上的圖案。', cost: 600, guide: '' },
      { id: 30, type: '餐飲', time: '12:30-14:00', title: '宇治午餐 & 抹茶甜點', detail: '必吃美食: 宇治茶蕎麥麵。必點菜單: 中村藤吉/伊藤久右衛門抹茶套餐。', cost: 2500, guide: '' },
      ...
      { id: 33, type: '餐飲', time: '17:30-20:00', title: '晚餐', detail: '在京都車站周邊用餐。', cost: 3000, guide: '' },
    ],
    weather: null,
  },
  {
    ...
    activities: [
      ...
      { id: 36, type: '餐飲', time: '13:00-14:30', title: '午餐: 彥根城周邊', detail: '推薦品嚐: 近江牛 (Omi Beef) 或當地特色料理。', cost: 5000, guide: '' },
      ...
      { id: 39, type: '購物', time: '18:30-20:30', title: '晚餐 & 採購伴手禮', detail: '最後機會在京都車站伊勢丹百貨或周邊採購禮品。', cost: 3000, guide: '' },
    ],
    weather: null,
  },
  {
